...
item_chances: Dict[int, List[Tuple[Entity, int]]] = {
    ...
    2: [(entity_factories.scrambler, 10)],
    4: [(entity_factories.lightning_scroll, 25), (entity_factories.servos, 5)],
    6: [(entity_factories.fireball_scroll, 25), (entity_factories.thrusters, 15)],
}
...
def generate_dungeon(
    ...
    for r in range(max_rooms):
        ...
        # Run thorught the other rooms and see if they intersect with this one
