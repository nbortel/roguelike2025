...
from input_handlers import (
        ActionOrHandler,
        AreaRangedAttackHandler, SingleRangedAttackHandler
)
...
class Consumable(BaseComponent):
    ...
    def get_action(
            self, consumer: Actor) -> Optional[ActionOrHandler]:
...
class FireballDamageConsumable(Consumable):
    ...
    def get_action(self, consumer: Actor) -> AreaRangedAttackHandler:
        ...
        return AreaRangedAttackHandler(
                self.engine, radius=self.radius,
                callback=lambda xy: actions.ItemAction(
                    consumer, self.parent, xy),
        )
...
class LightningDamageConsumable(Consumable):
    ...
    def activate(self, action: actions.ItemAction) -> None:
        ...
        for actor in self.engine.game_map.actors:
            if (actor is not consumer and
                    self.parent.gamemap.visible[actor.x, actor.y]):
